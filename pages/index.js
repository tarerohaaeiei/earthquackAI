...
function EarthquakeAI() {
  ...
  const calculateEarthquake = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://earthquakeai.site/predict', {
        Magnitude: magnitude,
        Depth: depth,
        Reaction: reaction,
      });
  ...
  const handleDownload = async () => {
    try {
      ...
      const response = await axios.get(`http://earthquakeai.site/download?year=${selectedYear}&month=${selectedMonth}`, {
        responseType: 'blob',
      });
